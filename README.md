...
<p>Create another class, Person, which has three member variables, a String for first name, a String for last name, and a UUID as a unique identifier. Accessor methods should be available for each, and there should be appropriate error checking for invalid inputs during construction.</p>
...
<img width="500" src="https://drive.google.com/uc?export=view&id=1viLoJugqsRwyBmm8Bx9aqS8uqMvRB0jO">
...
<img width="500" src="https://drive.google.com/uc?export=view&id=1L-GlgA4uHnVDHGc5xpIpcgiiszotBIDw">

Data Validation and Object creation:

It is used to check the data is in correct format from the file:

Condition:
	First name should not empty.
	UUID should not empty & in correct format of (237e9877-e79b-12d4-a765-321741963000)

<img width="500" src="https://drive.google.com/uc?export=view&id=1GHnc0JeR40Ostu53zobk91xW8_VBTScl">
